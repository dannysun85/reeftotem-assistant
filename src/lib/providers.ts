...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  ...
  { id: 'deepseek', name: 'DeepSeek', icon: '🐋', placeholder: 'sk-...', model: 'DeepSeek', requiresApiKey: true, defaultBaseUrl: 'https://api.deepseek.com', defaultModelId: 'deepseek-chat', showModelId: true, modelIdPlaceholder: 'deepseek-chat / deepseek-reasoner' },
  { id: 'dashscope', name: 'DashScope (阿里云)', icon: '☁️', placeholder: 'sk-...', model: 'Qwen', requiresApiKey: true, defaultBaseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', defaultModelId: 'qwen-turbo-latest', showModelId: true, modelIdPlaceholder: 'qwen-turbo-latest / qwen-plus-latest / qwen-max-latest' },
